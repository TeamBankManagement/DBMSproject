  ...
  <div className="flex h-full grow flex-col bg-white pl-2 dark:bg-navy-750">
    ...
    <div className="flex h-18 w-full items-center justify-between pl-4 pr-1">
      ...
      <button className="flex items-center justify-center
       h-7 w-7 rounded-full p-0 text-primary hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:text-accent-light/80 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 xl:hidden"
    ...
    <div className="flex h-[calc(100%-4.5rem)] grow flex-col">
      <div className="is-scrollbar-hidden grow overflow-y-auto">
        <div className="mt-2 px-4">
          <button className="flex items-center justify-center w-full space-x-2 rounded-full border border-slate-200 py-2 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-500 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
        ...
        <div className="mt-4 flex items-center justify-between px-4">
          <span className="text-xs font-medium uppercase">PAGES</span>
        ...
        <ul className="mt-1 space-y-1.5 px-2 font-inter text-xs+ font-medium">
          <li>
            <Link className="group flex justify-between space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600" href="/signup">
              <span className="text-slate-800 dark:text-navy-100">Signup</span>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4.5 w-4.5 text-error" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
            </Link>
          </li>
          <li>
            <Link className="group flex justify-between space-x-2 rounded-lg bg-primary/10 p-2 tracking-wide text-primary outline-none transition-all dark:bg-accent-light/10 dark:text-accent-light" href="/login">
              <span>Sign in</span>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4.5 w-4.5 text-error" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
          ...
          <li>
            <Link className="group flex justify-between space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600" href="/home">
              <span className="text-slate-800 dark:text-navy-100">Home</span>
            </Link>
          </li>
        </ul>
        <div className="mx-4 my-4 h-px bg-slate-200 dark:bg-navy-500" />
        <div x-data="{expanded:false}">
          <div className="flex items-center justify-between px-4">
            ...
            <div className="-mr-1.5 flex">
              ...
              <button  className="flex items-center justify-center h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 transition-transform rotate-180"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li>
                <Link className="group flex justify-between space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600" href="#">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-slate-800 dark:text-navy-100">Recent Transaction</span>
                  </div>
