          ...
          <div className="flex h-[calc(100%-4.5rem)] grow flex-col">
              ...
              {session?.user.acctype == "Customer" && (
                <div x-data="{expanded:false}">
                  <div className="flex items-center justify-between px-4">
                    ...
                    <div className="-mr-1.5 flex">
                      <button className="flex items-center justify-center h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"></button>
                      <button className="flex items-center justify-center h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"></button>
                    </div>
                  </div>
                  <div>
            ...
            <div className="flex justify-between p-4">
              {status === "authenticated" ? (
                <button
                  className="btn h-11 w-full justify-between bg-gradient-to-r from-purple-500 to-indigo-600 text-white"
                  onClick={() => signOut()}
                >
                  <span> Log Out </span>
                  <svg
