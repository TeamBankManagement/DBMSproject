...
const FormFooter = ({handleSubmit,setStep,step,handleSubmitdoc}) => {
    const nextClick=()=>{
        setStep(step+1);
    }
  ...
  return (
    ...
    <div className="flex justify-end space-x-2 mt-5">
                  ...
                  <button className="btn space-x-2 bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" onClick={nextClick}>
                    <span>Next</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
